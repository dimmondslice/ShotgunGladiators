...
public:	
	...
	virtual void TickState(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction);
	...
	virtual void ChangeUpperState(UGladiatorState* newState);
	/**Changes the current lower body state */
	virtual void ChangeLowerState(UGladiatorState* newState);
